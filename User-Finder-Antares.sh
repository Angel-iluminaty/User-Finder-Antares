...
printf "\n"
printf "\e[1;93m             .:.:;..\e[0m\e[1;77mUser-Finder-Antares v1.0 Creador: Angel Del Villar\e[0m\e[1;93m..;:.:.\e[0m\n"
printf "\n"
...
check_file() {
if [[ -e $username.txt ]]; then
printf "\e[1;92m[\e[0m\e[1;77mx\e[0m\e[1;92m] Eliminando el archivo anterior:\e[0m\e[1;77m %s.txt" $username
printf "\n\n"
rm -rf $username.txt
else
printf "\n"
...
global_IS() {
printf "\e[1;92m[\e[0m\e[1;77m>\e[0m\e[1;92m] Checking usuario\e[0m\e[1;77m %s\e[0m\e[1;92m en global info-ladron@: \e[0m\n" $username
...
if [[ $(jq -r '.stealers | length' <<< "$response") -eq 0 ]]; then
    printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] No se encontró ningún resultado\n\n"
else
    while IFS= read -r line; do
        ...
        printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] fecha : $date_compromised\n"
        printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Sistema operativo : $operating_system\n"
        printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] antivirus     : $antiviruses\n"
        printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] nombre de la computadora    : $computer_name\n"
        printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] dirección IP       : $ip\n"
        printf "\n"
...
printf "\e[1;92m[\e[0m\e[1;77m>\e[0m\e[1;92m] Checking usuario\e[0m\e[1;77m %s\e[0m\e[1;92m en las redes sociales: \e[0m\n" $username
...
printf "\e[1;93mNo Encontrada!\e[0m\n"
fi
...
if [[ $check == *'1'* ]]; then
printf "\e[1;92m Encontrada!\e[0m https://plus.google.com/+%s/posts\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.reddit.com/user/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://%s.wordpress.com\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.pinterest.com/%s\n" $username
...
check1=$(curl -s -i "https://www.github.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o '404 No Encontrada' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mNo Encontrada!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Encontrada!\e[0m https://www.github.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://%s.tumblr.com\n" $username
...
check1=$(curl -s -i "https://www.flickr.com/people/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o 'No Encontrada' ; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mNo Encontrada!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Encontrada!\e[0m https://www.flickr.com/photos/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://steamcommunity.com/id/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://vimeo.com/%s\n" $username
...
check1=$(curl -s -i "https://soundcloud.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o '404 No Encontrada'; echo $?)

if [[ $check1 == *'0'* ]] ; then 
printf "\e[1;93mNo Encontrada!\e[0m\n"
elif [[ $check1 == *'1'* ]]; then 

printf "\e[1;92m Encontrada!\e[0m https://soundcloud.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://disqus.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://medium.com/@%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://%s.deviantart.com\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://vk.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://about.me/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://open.spotify.com/user/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.mixcloud.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.scribd.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.badoo.com/en/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.patreon.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://bitbucket.org/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://cash.me/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.behance.net/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.goodreads.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.instructables.com/member/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://keybase.io/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://kongregate.com/accounts/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://%s.livejournal.com\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://angel.co/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://last.fm/user/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://dribbble.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.codecademy.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://en.gravatar.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://pastebin.com/u/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://foursquare.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.gumroad.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://%s.newgrounds.com\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.wattpad.com/user/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.canva.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://creativemarket.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.trakt.tv/users/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://500px.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://buzzfeed.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://tripadvisor.com/members/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://%s.hubpages.com/\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://%s.contently.com\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://houzz.com/user/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://blip.fm/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.wikipedia.org/wiki/User:%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://news.ycombinator.com/user?id=%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.codementor.io/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.reverbnation.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.designspiration.net/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.bandcamp.com/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.colourlovers.com/love/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.ifttt.com/p/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.ebay.com/usr/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://%s.slack.com\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.okcupid.com/profile/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.trip.skyscanner.com/user/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://ello.co/%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://tracky.com/~%s\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://www.tripit.com/people/%s#/profile/basic-info\n" $username
...
printf "\e[1;92m Encontrada!\e[0m https://%s.basecamphq.com/login\n" $username
...
banner
read -p $'\e[1;92m[\e[0m\e[1;77m>\e[0m\e[1;92m] nombre de usuario:\e[0m ' username
check_file
global_IS
scanner
